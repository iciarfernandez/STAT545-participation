---
title: "cm005.exploring.geometric.objects"
...
```{r, fig.width = 5, fig.height = 2}
#Able to override the aesthetics
ggplot(mauna, aes(y = month)) +
  geom_line(aes(x = month, y = conc))
#Still have to change the axis label by doing ylab because otherwise it labels both axis as 'month'
ggplot(mauna, aes(y = month)) +
  geom_line(aes(x = month, y = conc)) +
  ylab("co2")
```
